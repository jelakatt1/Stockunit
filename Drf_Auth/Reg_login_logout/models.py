...
class UserProfile(AbstractBaseUser, PermissionsMixin):
    ...
    stripe_info = models.JSONField(blank=True, null=True)
...
def uploaded_file_path(instance, filename):
    return "uploads/{user.username}/{filename}".format(user=instance.user, filename=filename)
...
class UploadFile(models.Model):
    ...
    file = models.FileField(upload_to=uploaded_file_path, blank=True, null=True)
